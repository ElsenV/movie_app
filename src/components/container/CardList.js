  ...
  return (
    <li>
      ...
      <Link to={"/movie/details"}>
        <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30  max-w-full h-auto rounded-sm">
          {" "}
          <img
