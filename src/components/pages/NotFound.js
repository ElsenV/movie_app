...
const NotFound = () => {
  return (
    <div className="h-screen ">
      <main class="h-screen w-full flex flex-col justify-center items-center bg-gray-400 dark:bg-[#1A2238]">
        ...
        <button class="mt-5">
          <div class="relative inline-block text-sm font-medium text-[#FF6A3D] group active:text-orange-500 focus:outline-none focus:ring">
            ...
            <span class="relative block px-8 py-3 bg-gray-500 dark:bg-[#1A2238] border border-current">
